...
<section class="cta-row">
    <div class="inner">
		...
		<div class="cta">
            <h3 class="small-heading">Talks</h3>
            <p>In elke sprint van de opleiding nodigen we een interessante spreker met relevante vakkennis uit, zodat de studenten (en de coaches) op de hoogte blijven van actuele ontwikkelingen in het vakgebied.</p>

            <a href="/talks" class="button is-dark"><span class="small-body">Meer over talks</span></a>
        </div>
    </div>
</section>
