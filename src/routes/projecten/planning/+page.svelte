  ...
  <div class="simple-text">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>Donderdag 29 Oktober</td>
            <td>14.00 - 15.00</td>
            <td><a href="#sprint-review">Sprint Review</a></td>
            <td><a href="#sprint-3">Sprint 3: All Human</a></td>
            <td>Op locatie bij de opdrachtgever</td>
          </tr>

          <tr>
            <td>Donderdag 26 November</td>
            <td>14.00 - 15.00</td>
            <td><a href="#sprint-review">Sprint Review</a></td>
            <td><a href="#sprint-4">Sprint 4: Look and Feel</a></td>
            <td>Op locatie bij de opdrachtgever</td>
          </tr>
          ...
          <tr>
            ...
            <td>14.00 - 15.00</td>
            <td><a href="#sprint-review">Sprint Review</a></td>
            <td><a href="#sprint-5">Sprint 5: Fix the Flow</a></td>
            <td>Op locatie bij de opdrachtgever</td>
          </tr>        
        </tbody>
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>Maandag 1 Maart</td>
            <td>11.00 - 12.30</td>
            <td><a href="#sprint-planning">Sprint Planning</a></td>
            <td><a href="#sprint-8">Sprint 8: Server-Side Rendering</a></td>
            <td>FDND Studio</td>
          </tr>

          <tr>
            <td>Donderdag 11 Maart</td>
            <td>14.00 - 15.00</td>
            <td><a href="#sprint-review">Sprint Review</a></td>
            <td><a href="#sprint-8">Sprint 8: Server-Side Rendering</a></td>
            <td>Op locatie bij de opdrachtgever</td>
          ...
          <tr>
            <td>Donderdag 1 April</td>
            <td>14.00 - 15.00</td>
            <td><a href="#sprint-review">Sprint Review</a></td>
            <td><a href="#sprint-9">Sprint 9: The Web is for Everyone</a></td>
            <td>Op locatie bij de opdrachtgever</td>
          </tr>

          <tr>
            <td>Donderdag 22 April</td>
            <td>14.00 - 15.00</td>
            <td><a href="#sprint-review">Sprint Review</a></td>
            <td><a href="#sprint-10">Sprint 10: User Experience</a></td>
            <td>Op locatie bij de opdrachtgever</td>
          </tr>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>14.00 - 15.00</td>
            <td><a href="#sprint-review">Sprint Review</a></td>
            <td><a href="#sprint-15">Sprint 15: Don't Repeat Yourself</a></td>
            <td>Op locatie bij de opdrachtgever</td>
          </tr>
          ...
          <tr>
            ...
            <td>14.00 - 15.00</td>
            <td><a href="#sprint-review">Sprint Review</a></td>
            <td><a href="#sprint-16">Sprint 16: Choices, Choices</a></td>
            <td>Op locatie bij de opdrachtgever</td>
          </tr>
          ...
          <tr>
            ...
            <td>14.00 - 15.00</td>
            <td><a href="#sprint-review">Sprint Review</a></td>
            <td><a href="#sprint-17">Sprint 17: User Needs</a></td>
            <td>Op locatie bij de opdrachtgever</td>
          </tr>
          ...
          <tr>
            ...
            <td>14.00 - 15.00</td>
            <td><a href="#sprint-review">Sprint Review</a></td>
            <td><a href="#sprint-18">Sprint 18: Release Candidate</a></td>
            <td>Op locatie bij de opdrachtgever</td>
          </tr>
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>Dinsdag 2 Maart</td>
            <td>10.00 - 11.30</td>
            <td><a href="#sprint-planning">Sprint Planning</a></td>
            <td><a href="#sprint-19">Sprint 19: Free Space</a></td>
            <td>Op locatie bij de opdrachtgever</td>
          </tr>
  ...
  <div class="simple-text">
    ...
    <section id="semester-1">
      ...
      <details id="sprint-5" open>
        ...
        <a href="https://programma.fdnd.nl/static-web/fix-the-flow">Meer informatie over Sprint 5: Fix the Flow</a>
      </details>
    ...
    <section id="semester-2">
      ...
      <details id="sprint-9" open>
        ...
        <h4>Resultaten</h4>
        <p class="body-text">
          De opdrachtgever ontvangt meerdere individuele, interactieve en toegankelijke uitwerkingen van de website. Deze bevatten een robuuste functionaliteit voor het invoeren en tonen van content, met heldere feedback voor gebruikers tijdens het proces. De studenten documenteren hun ontwerpkeuzes en testresultaten en verwerken de feedback van de opdrachtgever tijdens de Sprint Review als input voor de volgende sprint.
        </p>

        <a href="https://programma.fdnd.nl/data-driven-web/the-web-is-for-everyone">Meer informatie over Sprint 9: The Web is for Everyone</a>
      </details>

      <details id="sprint-10" open>
        ...
        <h4>Resultaten</h4>
        <p class="body-text">
          De opdrachtgever ontvangt meerdere individuele, verbeterde uitwerkingen van de website die snel laden en prettig te gebruiken zijn. De studenten presenteren aantoonbare performanceverbeteringen en interactieve functionaliteit die de gebruikerservaring verrijkt. Tijdens de Sprint Review verzamelen zij feedback op de verbeteringen als input voor de volgende sprint.
        </p>

        <a href="https://programma.fdnd.nl/data-driven-web/user-experience">Meer informatie over Sprint 10: User Experience</a>
      </details>

      <details id="sprint-11" open>
    ...
    <section id="semester-3">
      ...
      <details id="sprint-15" open>
        ...
        <a href="https://programma.fdnd.nl/workflow-tooling-frameworks/dont-repeat-yourself">Meer informatie over Sprint 15: Don't Repeat Yourself</a>
      </details>

      <details id="sprint-16" open>
      ...
      <details id="sprint-18" open>
        ...
        <h4>Resultaten</h4>
        <p class="body-text">
          De opdrachtgever ontvangt een live, complexe en interactieve webapplicatie die een onderbouwde oplossing biedt voor de projectvraag. Het resultaat is zorgvuldig getest, gedocumenteerd en technisch gereed om door een volgend team verder te ontwikkelen. Tijdens de Sprint Review levert het team de release candidate op en licht het de oplossing, testresultaten en eventuele resterende vervolgpunten toe.
        </p>

        <a href="https://programma.fdnd.nl/workflow-tooling-frameworks/release-candidate">Meer informatie over Sprint 18: Release Candidate</a>
      </details>
    </section>
    ...
    <section id="semester-4">
      ...
      <details id="sprint-19" open>
        ...
        <h4>Resultaten</h4>
        <p class="body-text">
          De opdrachtgever ontvangt iteratieve verbeteringen en nieuwe onderdelen voor het bestaande project, ontwikkeld en getest door een multidisciplinair team. Werk, keuzes, feedback en vervolgacties zijn vastgelegd in <a href="#github">GitHub</a>, zodat het project overdraagbaar blijft en volgende teams erop kunnen voortbouwen. De teams demonstreren hun voortgang regelmatig en gebruiken feedback van opdrachtgevers, gebruikers en coaches om het werk gericht verder te ontwikkelen.
        </p>

        <a href="https://programma.fdnd.nl/meesterproef/free-space">Meer informatie over Sprint 19: Free Space</a>
      </details>

      <details id="sprint-20" open>
        ...
        <a href="https://programma.fdnd.nl/meesterproef/final-sprint">Meer informatie over Sprint 20: Final Sprint</a>
      </details>
    </section>
...
<section id="woordenlijst">
  <div class="simple-text">
    ...
    <dl>
      <dt id="accessibility">Accessibility (toegankelijkheid)</dt>
      <dd>De mate waarin een website zonder belemmeringen gebruikt kan worden door verschillende mensen, ook door mensen met een beperking.</dd>

      <dt id="api">API</dt>
      <dd>Een programmeerinterface waarmee een website gegevens of functionaliteit kan opvragen bij een andere toepassing of dienst.</dd>

      <dt id="backlog">Backlog</dt>
      <dd>Een geordende lijst met wensen, verbeteringen, user stories en taken voor een project.</dd>

      <dt id="branch">Branch</dt>
      <dd>Een afzonderlijke ontwikkeltak in Git waarin je aan werk kunt werken zonder de hoofdversie direct te veranderen.</dd>

      <dt id="client-side-scripting">Client-side scripting</dt>
      <dd>Code die in de browser van de gebruiker draait, meestal JavaScript, om een interface interactief te maken.</dd>
      ...
      <dt id="component-library">Component library</dt>
      <dd>Een verzameling herbruikbare interfacecomponenten met afspraken over ontwerp, gedrag en code.</dd>

      <dt id="container-query">Container query</dt>
      <dd>CSS-regels waarmee een component reageert op de beschikbare ruimte van zijn container, in plaats van alleen op de schermbreedte.</dd>

      <dt id="content-first">Content-first</dt>
      <dd>Een werkwijze waarbij eerst de inhoud, structuur en informatiebehoefte worden bepaald voordat de interface wordt ontworpen.</dd>

      <dt id="css">CSS</dt>
      <dd>De taal waarmee de vormgeving, layout en responsiviteit van HTML-elementen worden bepaald.</dd>

      <dt id="data-driven">Data-driven</dt>
      <dd>Een website of toepassing waarvan pagina’s en onderdelen worden opgebouwd met gegevens uit bijvoorbeeld een database of API.</dd>

      <dt id="database">Database</dt>
      <dd>Een gestructureerde verzameling gegevens die kan worden opgeslagen, beheerd en opgevraagd.</dd>
      ...
      <dt id="framework">Framework</dt>
      <dd>Een verzameling hulpmiddelen en afspraken die helpt bij het gestructureerd ontwikkelen van een toepassing.</dd>

      <dt id="github">GitHub</dt>
      <dd>Een online platform voor versiebeheer van code, samenwerken via issues en pull requests en het bijhouden van projectwerk.</dd>

      <dt id="headless-cms">Headless CMS</dt>
      <dd>Een contentmanagementsysteem dat content via een API aanbiedt, zonder zelf de vormgeving of webpagina’s te verzorgen.</dd>

      <dt id="html">HTML</dt>
      <dd>De opmaaktaal waarmee de structuur en betekenis van content op een webpagina worden vastgelegd.</dd>

      <dt id="huisstijl">Huisstijl</dt>
      <dd>De vaste visuele identiteit van een organisatie, waaronder kleuren, typografie, beeldgebruik en vormgevingsregels.</dd>

      <dt id="informatiearchitectuur">Informatiearchitectuur</dt>
      <dd>De manier waarop content wordt geordend, benoemd en navigeerbaar gemaakt binnen een website of toepassing.</dd>

      <dt id="issue">Issue</dt>
      <dd>Een vastgelegd aandachtspunt in GitHub, zoals een taak, bug, onderzoeksvraag, feedbackpunt of user story.</dd>

      <dt id="javascript">JavaScript</dt>
      <dd>Een programmeertaal voor gedrag en interactie op websites, zowel in de browser als op de server.</dd>

      <dt id="liquid">Liquid</dt>
      <dd>Een templatingtaal waarmee data in een HTML-sjabloon kan worden verwerkt om webpagina’s te genereren.</dd>

      <dt id="nodejs">Node.js</dt>
      <dd>Een omgeving waarmee JavaScript buiten de browser kan draaien, bijvoorbeeld voor een webserver.</dd>

      <dt id="performance">Performance</dt>
      <dd>De snelheid en efficiëntie waarmee een website laadt, reageert en technische middelen gebruikt.</dd>

      <dt id="progressive-enhancement">Progressive Enhancement</dt>
      <dd>Een aanpak waarbij de basisfunctionaliteit voor iedereen werkt en aanvullende technieken alleen worden toegevoegd als browser en apparaat die ondersteunen.</dd>
      ...
      <dt id="responsive">Responsive</dt>
      <dd>Een ontwerp dat bruikbaar en leesbaar blijft op verschillende schermformaten en apparaten.</dd>

      <dt id="rest-api">REST API</dt>
      <dd>Een veelgebruikte API-vorm waarbij gegevens via webadressen en HTTP-verzoeken worden opgevraagd, toegevoegd of aangepast.</dd>

      <dt id="server-side-rendering">Server-side rendering</dt>
      <dd>Het genereren van HTML op de server, vaak met data uit een API of database, voordat de pagina naar de browser wordt gestuurd.</dd>

      <dt id="sprint">Sprint</dt>
      <dd>Een afgebakende werkperiode waarin een team een vooraf gekozen hoeveelheid werk uitvoert en oplevert.</dd>

      <dt id="sprint-planning">Sprint planning</dt>
      <dd>Het overleg aan het begin van een sprint waarin doelen, prioriteiten, taken en de werkwijze worden bepaald.</dd>
      ...
      <dt id="wcag">WCAG</dt>
      <dd>Internationale richtlijnen voor digitale accessibility: Web Content Accessibility Guidelines.</dd>

      <dt id="wireflow">Wireflow</dt>
      <dd>Een schematische weergave die schermen en de stappen of interacties tussen die schermen combineert.</dd>
    </dl>
  </div>
</section>
