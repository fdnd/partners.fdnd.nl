...
<section class="image-with-text is-reversed">
  ...
  <div class="text-container">
      <h2 class="large-heading">Stage</h2>
          ...
          <p>Het leerresultaat waar de studenten in de stage naar toe werken: <br><em>De student ontwerpt en ontwikkelt zelfstandig complexe gebruiksvriendelijke interactieve toepassingen voor het web. De student beheerst de principes van het web, kan API’s en databases gebruiken, kan tools en frameworks inzetten, en werken volgens gangbare ontwikkelmethoden.</em></p>
