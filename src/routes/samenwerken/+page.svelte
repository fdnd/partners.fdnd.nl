...
<section class="rounded blue-on-green">
    ...
    <p>FDND is een 2-jarige, praktijgerichte HBO opleidingen, waarin aan projecten werken voor echte opdrachtgevers is ingebed in het onderwijs.</p>
    <a href="https://fdnd.nl/">Bekijk meer informatie over FDND</a>
</section>
...
<section class="rounded blue-on-purple">
	<h3>Sprints</h3>
...
<section class="rounded purple-on-blue">
